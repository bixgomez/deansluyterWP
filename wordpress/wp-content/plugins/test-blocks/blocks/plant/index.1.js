( function( wp, blocks, editor, components, i18n, element ) {
	...
	registerBlockType( 'plants/plant-block', {
		...
		edit: function( props ) {
			...
			return [
				...
				el('div', { className: props.className },
				  el('div', {
					className: attributes.mediaID ? 'plant-image image-active' : 'plant-image image-inactive',
				...
				el('div', { className: 'plant-content', style: { textAlign: alignment } },
					el(RichText, {
					  key: 'editable',
					  tagName: 'h2',
					  ...
					  onChange: function (newLatinName) {
						props.setAttributes({ latinName: newLatinName })
					  }
					}),
					el( 'h3', {}, i18n.__( 'Details', 'plants' ) ),
						el(RichText, {
							tagName: 'ul',
							multiline: 'li',
							placeholder: i18n.__('Details...'),
		...
		save: function(props) {
			...
			return (
				el('div', { className: props.className },  
					el('div', { className: 'plant-image', style: { backgroundImage: 'url(' + attributes.mediaURL + ')' } },
						el('img', { src: attributes.mediaURL })
			  		),								
					el('div', { className: 'plant-content', style: { textAlign: attributes.alignment } },
					  el(RichText.Content, {
						tagName: 'h2',
						value: attributes.latinName
					  }),
