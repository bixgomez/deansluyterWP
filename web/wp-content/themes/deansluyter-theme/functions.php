<?php
/**
 * Deansluyter Theme functions and definitions
 *
...
if ( ! function_exists( 'deansluyter_theme_setup' ) ) :
	/**
	 ...
	 */
	function deansluyter_theme_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on Deansluyter Theme, use a find and replace
		 * to change 'deansluyter-theme' to the name of your theme in all the template files.
		 */
		...
		add_theme_support( 'custom-background', apply_filters( 'deansluyter_theme_custom_background_args', array(
...
add_action( 'after_setup_theme', 'deansluyter_theme_setup' );
 ...
 */
function deansluyter_theme_widgets_init() {
...
function deansluyter_theme_scripts() {
    ...
    wp_enqueue_style( 'deansluyter-theme-styles', get_template_directory_uri() . '/styles/css/styles.css' );
...
function deansluyter_acf_init() {

  if( ! function_exists('deansluyter_acf_init') )
    return;
...
add_action('acf/init', 'deansluyter_acf_init');

//* Add image sizes
add_action( 'after_setup_theme', 'deansluyter_image_sizes' );
function deansluyter_image_sizes() {
