...
namespace ConstantContact\ConstantContactForms\Monolog;

use Closure;
use DateTimeZone;
use Fiber;
use ConstantContact\ConstantContactForms\Monolog\Handler\HandlerInterface;
use ConstantContact\ConstantContactForms\Monolog\Processor\ProcessorInterface;
use ConstantContact\ConstantContactForms\Psr\Log\LoggerInterface;
use ConstantContact\ConstantContactForms\Psr\Log\InvalidArgumentException;
...
class Logger implements LoggerInterface, ResettableInterface
{
     ...
     *
     * @throws \ConstantContact\ConstantContactForms\Psr\Log\InvalidArgumentException If level is not defined
     *
     * @phpstan-param  value-of<Level::VALUES>|Level $level
